...
## 6. Дополнительные возможности CRM-системы
...
### 6.4 Автоматизация маркетинга и цепочек писем
...
### 6.5 Интеграция с социальными сетями
...
### 6.8 Персонализированные предложения и скидки
